...
setFormValues({ ...formValues, [dateType]: formattedDate });
  ...
  //   e.preventDefault();
  //   // Perform actions with formValues like submitting to backend
  ...
  const handleSubmit = (event) => {
    ...
    dispatch(createEventAction({data:formValues, restaurantId: id }));
    alert("Event Created Successfully!")
console.log("Image URL:", formValues);
setFormValues(initialValues)
handleCloseModal()
  };

  useEffect(() => {
    dispatch(getRestaurnatsEvents(id));
  }, [id]);
    ...
    <div>
      {/* <Card className="p-5">
        <form onSubmit={handleSubmit}>
          <h1 className="py-5 font-semibold text-xl">Create New Events</h1>
