...
const MenuItemCard = ({ item }) => {
  ...
  // const handleCheckboxChange = (ingredientName, ingredientItemName) => {
  //   setSelectedIngredients((prevSelected) => {
  //     const newSelected = { ...prevSelected };
  //     if (!newSelected[ingredientName]) {
  //       newSelected[ingredientName] = [];
  //     }
  //     if (newSelected[ingredientName].includes(ingredientItemName)) {
  //       newSelected[ingredientName] = newSelected[ingredientName].filter(
  //         (item) => item !== ingredientItemName
  //       );
  //     } else {
  //       newSelected[ingredientName].push(ingredientItemName);
  //     }
  //     return newSelected;
  //   });
  // };
