...
dispatch(getAllRestaurantsAction(localStorage.getItem("jwt")))
  ...
  return (
    <div className="">
      ...
      {/* <section className="-z-50 banner relative flex flex-col justify-center items-center"></section> */}
        <div className="w-[50vw] z-10 text-center">
          <p className="text-2xl lg:text-7xl font-bold z-10 py-5">Web Dine</p>
          <p className="z-10   text-gray-300 text-xl lg:text-4xl">
            Don't Wait In Line! Order and Pay Online.
          </p>
        </div>
